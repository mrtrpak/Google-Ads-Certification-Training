...
- Keywords: words or phrases that help determine where and when your ad can appear. Building a solid keyword list helps you reach only the most intersted people who are more likely to become your customer.
...
4) Pick the Right Number of Keywords:
  ...
  - Use the DISPLAY PLANNER to see how to reach your target audience based on keywords, websites or 
  interest categories.
...
19) If set a maximum cost-per-click (CPC) of $2 for your ads and the next most competitive bid is $1 for the same ad position, what is the actual amount you'd pay for that click?
